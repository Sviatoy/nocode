...
#define STRING_CONFIG_H_AUTHOR "(@YK)" // Original author or contributor.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 36.91
    #define DEFAULT_Ki 5.01
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 128 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 300, 30000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 20, 3, 0 }
...
#define XY_AFTER_HOMING { 5, 5 }  // (mm) Move to an XY position after homing (and raising Z)
